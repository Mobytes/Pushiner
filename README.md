...
------------ | ------------- | ------------ | ----------
token_user | String | Si | Su clave de usuario. Puede encontrar su ```json token_user``` en la sección de configuración de su aplicación                             dentro del portal de desarrolladores.

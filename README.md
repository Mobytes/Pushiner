...
------------ | ------------- | ------------ | ----------
token_user | String | Si | Su clave de usuario. Puede encontrar su foo <font color='red'>token_user</font> foo en la sección de configuración de su aplicación                             dentro del portal de desarrolladores.
